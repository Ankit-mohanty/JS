...
/* 
->  concatenation of string we use " + " symbol. But is not use in modern js. We can also use template literals to concat
...
// console.log(mm.charAt(2));// In charAt function we have to put the index value fo the character to find it.
// console.log(mm.indexOf('t'));// in this function we  use it to find the index value of the  character.

console.log(mm.substring(0, 4)); // here substring method used from which index number to which index number want to print. output : Ankit index value is 0,1,2,3 only. 4 is not cunt in this function.
// in substring function we can not pass -ve value if we pss the -ve value it will out form the binging.
...
// in replace function first value is which value we ant to change and second is  what we want to put instead of that value.
...
const mm2 = "ankit-mohanty-rahul";// i want to convert this string to array based on  "-". We can do anything instead of the '-'.
console.log(mm2.split('-'));// we use this function to convert a string to array.
...
console.log(mm2.startsWith('a'));// this method check the method  that our string starts with or not.// this method return type is BOOLEAN
console.log(mm2.endsWith('a'));// This method  check that our string ends with or not.  this method return type is BOOLEAN

// console.log(mm2.padStart(25));//this function add Hi at the starting side of the string.iF WE DO not pass any value in it it will pass use "<space >" to increase the string length.
console.log(mm2.padEnd(21, 'hi'));// this function add Hi at the ending side of the string.iF WE DO not pass any value in it it will pass use "<space >" to increase the string length.
console.log(mm2.length);

console.log(mm.repeat(5));// this method is use to repeat the value of it.

console.log(mm2.search("n"));// This returns index value of the giver character..
